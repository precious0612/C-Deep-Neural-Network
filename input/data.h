...
///   - data_type: The type of data that the image will be converted to (e.g., `INT` or `FLOAT32`).
...
///     InputData* image_data = load_input_data_from_image("path/to/image.jpg", &img_dims, INT);
///     if (image_data == NULL) {
///         // Handle error
///     }
///     ```
...
///   - data_type: The type of data stored in the image data (e.g., `INT` or `FLOAT32`).
...
/// - Example Usage:
///     ```c
///     InputData* image_data = create_empty_input_data(640, 480, 3, INT, 0);
///     if (image_data == NULL) {
///         // Handle error
///     }
///     ```
...
///     int result = resize_image(&image_data, orig_dims, new_dims, INT);
///     if (result != 0) {
///         // Handle error
///     }
///     ```
...
/// - Example Usage:
///     ```c
///     InputData* image_data = create_image_data(orig_dims, INT);
///     // ... image manipulation code ...
///     free_image_data(image_data, orig_dims, INT);
///     ```
///
