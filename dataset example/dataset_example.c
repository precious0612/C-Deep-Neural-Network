...
int main() {
    ...
    Dataset* dataset = load_dataset_from_json("dataset example/test_data_without_val/dataset.json", input_dimensions, SINT32, 0);
    if (dataset == NULL) {
    ...
    printf("Data Type: %s\n", dataset->data_type == SINT32 ? "SINT32" : "FLOAT32");
