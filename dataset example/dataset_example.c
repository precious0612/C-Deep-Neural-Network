...
int main() {
    ...
    Dataset* dataset = load_dataset_from_json("dataset example/test_data_without_val/dataset.json", input_dimensions, UINT32, 0);
    if (dataset == NULL) {
    ...
    printf("Data Type: %s\n", dataset->data_type == UINT32 ? "UINT32" : "FLOAT32");
